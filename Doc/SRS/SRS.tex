...
\begin{tabular}{ |m{2cm}|m{1.8cm}|m{9.4cm}| }
    ...
    \hline
    NFREQ5 & 3 & The GUI's components will be consistent in colour, text fonts, and window properties on order to keep the application organized and easy to navigate. \\ 
    \hline
\end{tabular}
\end{table}
...
\begin{tabular}{ |m{2cm}|m{1.8cm}|m{9.4cm}| }
    ...
    \hline
    NFREQ14 & 4 & The application will not interfere with the users machine. \\
    \hline
\end{tabular}
\end{table}
