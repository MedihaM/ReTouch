...
/**
 * The MakeResults class constructs the UI page that displays the user's results
 * of the selected lesson.
 * 
 * <p>
 * Major Revision History:
 * <p>
 * 2017-11-09 Results appear successfully
 * <p>
 * 2017-11-27 Graphics improved and buttons added
 * <p>
 * 2017-11-27 Buttons edited
 * 
 * @author Abrar Attia
 * @version 2.0
 * @since 2017-11-09
...
public class MakeResults extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		g.drawString("Elapsed time: " + Integer.toString(Scheduler.elapsedTime) + "s", MakeResults.width / 3,
				2 * height / 3);
		g.drawString("Accuracy: " + Integer.toString(Scheduler.accuracy()) + "%", MakeResults.width / 3,
				2 * height / 3 + 50);
		g.drawString("Characters/Minute: " + Integer.toString(Scheduler.counter()), MakeResults.width / 3,
				2 * height / 3 + 100);
	}
