...
/**
 * The SelectionPage class builds and runs the frame for the Lesson Selection page
 * @author Susan Fayez
 * @version 1.0
 * @since 2017-11-06
 */
public class SelectionPage extends javax.swing.JFrame {
     ...
     * This method runs the function that creates the form for the page
     */
     ...
     * @param evt stores the status of the button
     * @throws IOException 
     */
     ...
     * @param args the command line arguments (none apply in this case)
     */
